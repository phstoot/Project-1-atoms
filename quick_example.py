...
if __name__ == '__main__':
    test_simulation = Simulation(num_particles=256, temp=0.5, density=1.2, optimized=True) 
    ...
    ax.scatter(test_simulation.positions[:,0], test_simulation.positions[:,1], test_simulation.positions[:,2])
    ax.set_aspect('equal')
