...
After running a basic simulation, the history of the simulation can be accessed through the available attributes for plotting, i.e.:  
pot_energy = sim.e_pot_hist
